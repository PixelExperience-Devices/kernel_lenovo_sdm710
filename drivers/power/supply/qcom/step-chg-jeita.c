...
#define STEP_CHG_HYSTERISIS_DELAY_US		3000000 /* 3 secs */
		...
		bool step_chg_enable, bool sw_jeita_enable)
{
	...
	INIT_DEFERRABLE_WORK(&chip->status_change_work, status_change_work);
	INIT_DEFERRABLE_WORK(&chip->get_config_work, get_config_work);
