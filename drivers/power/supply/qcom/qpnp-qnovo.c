...
static int qnovo_probe(struct platform_device *pdev)
{
	...
	INIT_DEFERRABLE_WORK(&chip->dc_debounce_work, dc_debounce_work);
	INIT_DEFERRABLE_WORK(&chip->usb_debounce_work, usb_debounce_work);
	INIT_DEFERRABLE_WORK(&chip->ptrain_restart_work, ptrain_restart_work);
