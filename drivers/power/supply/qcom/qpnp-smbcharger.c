...
static int smbchg_probe(struct platform_device *pdev)
{
	...
	INIT_DEFERRABLE_WORK(&chip->parallel_en_work,
			smbchg_parallel_usb_en_work);
	INIT_DEFERRABLE_WORK(&chip->vfloat_adjust_work, smbchg_vfloat_adjust_work);
	INIT_DEFERRABLE_WORK(&chip->hvdcp_det_work, smbchg_hvdcp_det_work);
